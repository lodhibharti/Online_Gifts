...
<h1 class="text-center"style="font-family:'Comic Sans MS';color:#0099FF;font-size:40px">View Product</h1>
<?php
...
while($row = mysqli_fetch_array($recieve) )
{
 ...
 $recieve1=my_select($query1);
 if($row1=mysqli_fetch_array($recieve1))
 {
   echo"<td>$row1[1]</td>";
 }
 echo"<td>$row[4]</td>";
 echo"<td>$row[5]</td>";
 echo"<td><a href='deletproduct.php?id=$row[0]' class='btn btn-danger'>Delete</td>";
 echo"</tr>";
}
echo"</tbody>";
