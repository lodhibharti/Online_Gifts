...
<h1 class="text-center"style="font-family:'Comic Sans MS';color:#0099FF;font-size:40px">View Booking</h1>
<?php
...

{
 ...
 echo"<td>$row[10]</td>";
 echo"<td>$row[11]</td>";
 echo"<td><a href='deletecustomer.php?id=$row[11]' class='btn btn-danger'>Delete</td>";
 echo"</tr>";
}
echo"</tbody>";
echo"</table>";
